...
as:CreateTopbarButton("Settings","settings",function() end, 997, nil, Color3.fromHex"#3b82f6")
...
as:CreateTopbarButton("Statistics","bar-chart",function() end, 998, nil, Color3.fromHex"#a855f7")
